/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/LoopingTrackAssociationAlgorithm.h
 * 
 *  @brief  Header file for the looping track association algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_LOOPING_TRACK_ASSOCIATION_ALGORITHM_H
#define CMS_LOOPING_TRACK_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef CMS_LOOPING_TRACK_ASSOCIATION_ALGORITHM_H

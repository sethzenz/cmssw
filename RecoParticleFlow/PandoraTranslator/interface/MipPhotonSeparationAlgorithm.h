/**
 *  @file   "RecoParticleFlow/PandoraTranslator/interface/MipPhotonSeparationAlgorithm.h
 * 
 *  @brief  Header file for the mip-photon separation algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_MIP_PHOTON_SEPARATION_ALGORITHM_H
#define CMS_MIP_PHOTON_SEPARATION_ALGORITHM_H 1
...
#endif // #ifndef CMS_MIP_PHOTON_SEPARATION_ALGORITHM_H

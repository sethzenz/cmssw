/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/SplitTrackAssociationsAlg.h
 * 
 *  @brief  Header file for the split track associations algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_SPLIT_TRACK_ASSOCIATIONS_ALGORITHM_H
#define CMS_SPLIT_TRACK_ASSOCIATIONS_ALGORITHM_H 1
...
#endif // #ifndef CMS_SPLIT_TRACK_ASSOCIATIONS_ALGORITHM_H

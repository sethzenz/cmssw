/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/TrackRecoveryHelixAlgorithm.h
 * 
 *  @brief  Header file for the track recovery helix algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_TRACK_RECOVERY_HELIX_ALGORITHM_H
#define CMS_TRACK_RECOVERY_HELIX_ALGORITHM_H 1
...
#endif // #ifndef CMS_TRACK_RECOVERY_HELIX_ALGORITHM_H

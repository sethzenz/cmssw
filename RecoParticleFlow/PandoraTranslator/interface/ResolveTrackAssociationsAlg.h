/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/ResolveTrackAssociationsAlg.h
 * 
 *  @brief  Header file for the resolve track associations algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H
#define CMS_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H 1
...
#endif // #ifndef CMS_RESOLVE_TRACK_ASSOCIATIONS_ALGORITHM_H

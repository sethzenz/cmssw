/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/ExitingTrackAlg.h
 * 
 *  @brief  Header file for the exiting track algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_EXITING_TRACK_ALGORITHM_H
#define CMS_EXITING_TRACK_ALGORITHM_H 1
...
#endif // #ifndef CMS_EXITING_TRACK_ALGORITHM_H

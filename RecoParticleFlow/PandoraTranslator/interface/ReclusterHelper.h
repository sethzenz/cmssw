/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/ReclusterHelper.h
 * 
 *  @brief  Header file for the recluster helper class. (cms style)
 * 
 *  $Log: $
 */
#ifndef CMS_RECLUSTER_HELPER_H
#define CMS_RECLUSTER_HELPER_H 1
...
public:
     ...
     *  @param  trackEnergyError2 the sum in quadrature of the associated track energy errors
     * 
     *  @return the chi value for the suitability of the track/cluster associations
     */
    static float GetTrackClusterCompatibility(const pandora::Pandora &pandora, const float clusterEnergy, const float trackEnergy, const float trackEnergyError2);
...
#endif // #ifndef CMS_RECLUSTER_HELPER_H

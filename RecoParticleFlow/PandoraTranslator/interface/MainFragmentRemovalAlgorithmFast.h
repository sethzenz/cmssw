/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/MainFragmentRemovalAlgorithmFast.h
 * 
 *  @brief  Header file for the main fragment removal algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_MAIN_FRAGMENT_REMOVAL_ALGORITHM_FAST_H
#define CMS_MAIN_FRAGMENT_REMOVAL_ALGORITHM_FAST_H 1
...
using lc_content_fast::FragmentRemovalHelper;
using lc_content_fast::ClusterContact;
...
public:
     ...
     *  @return The sum of energies of tracks associated with parent cluster
     */
    float GetParentTrackEnergyError2() const;
...
private:
    ...
    float               m_parentTrackEnergyError2;      ///< Sum in quadrature of energy errors of tracks associated with parent cluster
...
inline float ChargedClusterContact::GetParentTrackEnergyError2() const
{
    return m_parentTrackEnergyError2;
}
...
#endif // #ifndef CMS_MAIN_FRAGMENT_REMOVAL_ALGORITHM_FAST_H

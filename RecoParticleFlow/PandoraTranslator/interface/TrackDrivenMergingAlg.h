/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/TrackDrivenMergingAlg.h
 * 
 *  @brief  Header file for the track driven merging algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_TRACK_DRIVEN_MERGING_ALGORITHM_H
#define CMS_TRACK_DRIVEN_MERGING_ALGORITHM_H 1
...
#endif // #ifndef CMS_TRACK_DRIVEN_MERGING_ALGORITHM_H

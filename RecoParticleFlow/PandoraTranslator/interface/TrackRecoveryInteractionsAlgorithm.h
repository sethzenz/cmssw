/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/TrackRecoveryInteractionsAlgorithm.h
 * 
 *  @brief  Header file for the track recovery interactions algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_TRACK_RECOVERY_INTERACTIONS_ALGORITHM_H
#define CMS_TRACK_RECOVERY_INTERACTIONS_ALGORITHM_H 1
...
#endif // #ifndef CMS_TRACK_RECOVERY_INTERACTIONS_ALGORITHM_H

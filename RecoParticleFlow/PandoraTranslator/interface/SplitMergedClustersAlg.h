/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/SplitMergedClustersAlg.h
 * 
 *  @brief  Header file for the split merged clusters algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_SPLIT_MERGED_CLUSTERS_ALGORITHM_H
#define CMS_SPLIT_MERGED_CLUSTERS_ALGORITHM_H 1
...
#endif // #ifndef CMS_SPLIT_MERGED_CLUSTERS_ALGORITHM_H

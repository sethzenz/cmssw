/**
 *  @file   RecoParticleFlow/PandoraTranslator/interface/MuonClusterAssociationAlgorithm.h
 * 
 *  @brief  Header file for the muon cluster association algorithm class.
 * 
 *  $Log: $
 */
#ifndef CMS_MUON_CLUSTER_ASSOCIATION_ALGORITHM_H
#define CMS_MUON_CLUSTER_ASSOCIATION_ALGORITHM_H 1
...
#endif // #ifndef CMS_MUON_CLUSTER_ASSOCIATION_ALGORITHM_H
